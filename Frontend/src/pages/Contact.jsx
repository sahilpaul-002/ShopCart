    ...
    <div className='w-[99vw] min-h-[100vh] flex items-center justify-center flex-col  bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px]'>
      ...
      <div className='w-[100%]  flex items-center justify-center flex-col lg:flex-row'>
        ...
        <div className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
          <p>23 Bridgehampton Street</p>
          <p>Manchester City, London</p>
        </div>
        <div className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
          <p>tel: +91-7439475212</p>
        ...
        <button className='px-[30px] py-[20px] flex items-center justify-center text-[white] bg-transparent border hover:bg-slate-600 rounded-md' >Explore Jobs</button>
        </div>
      </div>
      <NewLetterBox/>
